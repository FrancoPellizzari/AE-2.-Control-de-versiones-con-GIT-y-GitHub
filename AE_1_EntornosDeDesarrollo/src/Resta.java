/**
 * Esta clase está dedicada a implementar los métodos de resta necesarios para implementar una series de clase que compongan una calculadora.
 * Cada clase que compone los métodos de resta están documentados para poder instruirse en caso de necesitar información del método. 
...
public class Resta {
	...
	public double restaValorAcumulado(double numero) {
		// Inicializo la variable "acumulado" para que no salte ningún error. 
